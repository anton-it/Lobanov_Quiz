...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level4);//Установили текст (номер уровня)
        ...
        * сделать отдельно это ниже чтоб далее использовать в присвоении картинок*/
        ...
        dialogfon.setBackgroundResource(R.drawable.previewbackgroundone4);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    Intent intent = new Intent(Level4.this, GameLavels.class);//Создали намерение для перехода
        ...
        dialogfonEnd.setBackgroundResource(R.drawable.previewbackgroundone4);
        //Устанавливаем фон диалогового окна - конец
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    Intent intent = new Intent (Level4.this, GameLavels.class);
        ...
        img_left.setImageResource(array.images4[numLeft]);//Достаем из массива рандомную картинку
        text_left.setText(array.text4[numLeft]);//Достаем из массива текст
        ...
        img_right.setImageResource(array.images4[numRight]);//Достаем из массива рандомную картинку
        text_right.setText(array.text4[numRight]);//Достаем из массива текст
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==20) {
                        ...
                        if (level>4) {
                            ...
                            editor.putInt("Level", 5);//Установили для параметра Level цифру 2 потому что уровень пройден и мы пишем цифру следующего уровня
                            editor.commit();
                        }
                        dialogEnd.show();;
                    }else {
